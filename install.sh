...
echo "  1. Edit ${CONFIG_DIR}/config.yaml — set server_url"
echo "  2. Buat host di dashboard monitoring, salin registration token"
echo "  3. Register agent:"
echo "     ${INSTALL_DIR}/venv/bin/python -m server_monitor_agent register \\"
echo "       --server-url https://YOUR_SERVER --token YOUR_REGISTRATION_TOKEN"
echo "  4. Start service:"
echo "     systemctl enable --now server-monitor-agent"
